...
module Mailjet
  module Resource
    ...
    included do
      cattr_accessor :resource_path, :public_operations, :read_only, :filters, :resourceprop, :action
      ...
      def self.default_headers
        default_headers = { accept: :json, accept_encoding: :deflate, content_type: :json }
